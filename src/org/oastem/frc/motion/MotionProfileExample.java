...
public class MotionProfileExample {
	...
	private double[][] selectedProfile;
	...
	public void control() {
		...
		if (_talon.getControlMode() != TalonControlMode.MotionProfile) {
			 ...
			 * do.
			 */
			SmartDashboard.putNumber("State: ", _state);
			switch (_state) {
				...
				case 2: /* check the status of the MP */
					...
					if (_status.activePointValid && _status.activePoint.isLastPoint) {
						...
						//SmartDashboard.putNumber("Last Point Vel: ", _status.activePoint.velocity);
						//_state = 0;
						_loopTimeout = -1;
					}
					//SmartDashboard.putNumber("Bottom Buffer: ", _status.btmBufferCnt);
					//SmartDashboard.putNumber("Point Position: ", _status.activePoint.position);
					//SmartDashboard.putNumber("Point Velocity: ", _status.activePoint.velocity);
					//SmartDashboard.putNumber("Point Profile Slot Select: ", _status.activePoint.profileSlotSelect);
	...
	private void startFilling() {
		...
		startFilling(selectedProfile, selectedProfile.length);
	}
