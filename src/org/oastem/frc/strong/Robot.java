...
public class Robot extends SampleRobot {
	...
	private final double STRAIGHT_DRIVE_SPEED = 0.3;
	private final double SLOWER_DRIVE_SPEED = 0.2;
	...
	public void autonomous() {
		timer.start();
		int autonomousCase = SELF_CORRECT_DRIVE;
		...
		while (isAutonomous() && isEnabled()) {
			...
			switch (autonomousCase)
			{
				...
				case SELF_CORRECT_DRIVE: 
					...
					{
						if (centerXCoor >= HALF_RES_LEFT && centerXCoor <= HALF_RES_RIGHT)
							talonDrive.reverseTankDrive(SLOWER_DRIVE_SPEED, SLOWER_DRIVE_SPEED);
